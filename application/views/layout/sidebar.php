 ...
 <li class="treeview <?php echo set_Topmenu('Online_Examinations'); ?>">
            ...
            if ($this->module_lib->hasActive('academics')) {
                if (($this->rbac->hasPrivilege('class_timetable', 'can_view') ||
                        ...
                        $this->rbac->hasPrivilege('room_no', 'can_view') || 
                        $this->rbac->hasPrivilege('section', 'can_view')
                        )) {
                    ?>
                    <li class="treeview <?php echo set_Topmenu('Academics'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('room_no', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('room_nos/index'); ?>"><a href="<?php echo base_url(); ?>room_nos"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('room_no'); ?></a></li>
                                <?php
                            }
