<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">
            <?php
            if ($this->rbac->hasPrivilege('room_no', 'can_add')) {
                ?>
                <div class="col-md-4">
                    <div class="box box-primary">
                        ...
                        <form action="<?php echo site_url('room_nos/index') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
