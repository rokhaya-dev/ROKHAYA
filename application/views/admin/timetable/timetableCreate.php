...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function () {
                    ...
                    $(document).on("click", ".addrow", function () {
                        ...
                        cols += '<td class="relative"><input type="hidden" name="total_row[]" value="' + tot_count + '"><input type="hidden" name="prev_id_' + tot_count + '" value="0"><select class="form-control room_no" id="room_no_id_' + tot_count + '" name="room_no_' + tot_count + '">' + $("#room_no_dropdown").text() + '</select></td>';
            ...
            <script type="text/template" id="room_no_dropdown">
                <option value=""><?php echo $this->lang->line('select')?></option>
                <?php
                foreach ($room_no as $room_no_key => $room_no_value) {
                    ?>
                    <option value="<?php echo $room_no_value['id']; ?>"><?php echo $room_no_value->room_no ;?> </option>
                    <?php
                }
                ?>
            </script>
